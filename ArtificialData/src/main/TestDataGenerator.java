...
public class TestDataGenerator {
    ...
    public static void main(String[] args) {
        ...
        new GPSTable(2500000).createGPSTable(dataGen, table.getLayout(IOT_LAYOUTPATH+"Layout_GPS.csv"), table.getSyaryo());
        new SMRTable(2500000).createSMRTable(dataGen, table.getLayout(IOT_LAYOUTPATH+"Layout_SMR.csv"));
    }
}
